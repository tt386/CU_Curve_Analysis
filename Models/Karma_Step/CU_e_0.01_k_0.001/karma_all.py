...
hb1_period = load(run1('HB1'),IPS=2,ICP=["I",11],NMX=1000000000,NPR=100000,DS=0.000001,DSMAX=0.0001,SP=['BP0'])
...
homoclinic = load(u_period("UZ1"),IPS=2,ICP=["I","c"],NMX=10000,NPR=100,DS=0.0001,DSMAX=0.01)
